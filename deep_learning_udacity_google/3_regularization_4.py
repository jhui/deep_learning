...
with tf.Session(graph=graph) as session:
    ...
    print("\nInitialized with regularization value: %.5f" % lmbda_value)
...
# Initialized with regularization value: 0.00100 with decay learning rate
# Test accuracy: 93.1%
# Completed. Trained with regularization value: 0.00100 with decay learning rate.
