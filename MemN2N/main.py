...
from mm_data import read_data
from mm_model import MemN2N

pp = pprint.PrettyPrinter()

flags = tf.app.flags

flags.DEFINE_integer("edim", 150, "Embedding internal state dimension [150]")
...
flags.DEFINE_float("init_u", 0.1, "initial internal state value [0.1]")
